...
// component scan을 통해서 bean이 될수 있도록 서비스 클래스는 @Service 어노테이션을 붙인다
@Service
public class GuestServiceImpl implements GuestService{
	...
	//메소드의 인자로 전달된 ModelAndView 객체가 글하나의 정보를 담는 로직을 처리하는 메소드
	@Override
	...
	//메소드의 인자로 전달된 ModelAndView 객체가 글목록의 정보를 담는 로직을 처리하는 메소드
	@Override
